...
-- ************************************************************************************ --
-- DEFINE YOUR SETS HERE, SCOND SONT GETS MARCATO (SO WE DONT OVWRITE IT WITH PIANISSIMO)
...
bff_sets.sheol = {'Valor Minuet IV', 'Honor March', 'Valor Minuet V', 'Victory March',  "Knight's Minne V"}
...
bff_sets.mboze = {'Valor Minuet IV', 'Honor March', 'Valor Minuet V', "Adventurer's Dirge", "Sentinel's Scherzo"}
