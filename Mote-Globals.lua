...
function global_on_load()
	...
	send_command('bind pageup input //ata on;input //lua r AutoWS;input //aws on;input //lua load Gaze_check;input //lua load ws')
	send_command('bind pagedown input //ata off;input //aws off;input //lua unload Gaze_check;input //lua unload ws')
	--send_command('lua r AutoWS')
