return {
    ...
    ["Leshonn"]={
        ["Undulating Shockwave"]={
            ["complete_reaction"]="input /ma 'Hyoton: San' <bt>",
            ["ready_reaction"]="input /p Changing to Wind Hands! >>> PROC ICE <<< <call7>"
        },
        ["Shrieking Gale"]={
            ["complete_reaction"]="input /ma 'Doton: San' <bt>",
    ...
    ["Degei"]={
        ["Flaming Kick"]={
            ["complete_reaction"]="input /ma 'Suiton: San' <bt>",
            ["ready_reaction"]="input /p Flaming Kick >>> PROC WATER <<< <call7>"
        },
        ["Flashflood"]={
            ["complete_reaction"]="input /ma 'Raiton: San' <bt>",
            ["ready_reaction"]="input /p  Flashflood  >>> PROC THUNDER <<< <call7>"
        },
        ["Icy Grasp"]={
            ["complete_reaction"]="input /ma 'Katon: San' <bt>",
            ["ready_reaction"]="input /p  Icy Grasp >>> PROC FIRE <<< <call7>"
        },
        ["Eroding Flesh"]={
            ["complete_reaction"]="input /ma 'Huton: San' <bt>",
